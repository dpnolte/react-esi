...
test("serveFragment", function () { return __awaiter(_this, void 0, void 0, function () {
...
test("serveFragment complex", function () { return __awaiter(_this, void 0, void 0, function () {
    var app, resolver, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                resolver = function (fragmentID, props, req, res) {
                    ...
                    expect(res).toBeDefined();
                    return function (p) {
                        return (react_1.default.createElement("div", { className: "css-a5qmhs e1e5uckb0" },
                            react_1.default.createElement("div", { className: "css-910pwr e1e5uckb1" },
                                react_1.default.createElement("img", { src: "/static/media/yoda.e216d82d.svg", className: "css-r62z6h e1e5uckb2" }),
                                react_1.default.createElement("h2", null, "Page 3")),
                            react_1.default.createElement("p", { className: "css-iqjf8m e1e5uckb3" },
                                "To get started, edit",
                                react_1.default.createElement("code", null, "src/apps/Page3/App.tsx"),
                                "and save to reload."),
                            react_1.default.createElement("ul", { className: "css-o9b79t e1e5uckb4" },
                                react_1.default.createElement("li", { className: "css-bkrwwc e1e5uckb5" },
                                    react_1.default.createElement("a", { href: "/" }, "Go back home")))));
                    };
                };
                app.get(server_1.path, function (req, res) {
                    return server_1.serveFragment(req, res, resolver);
...
test("initial props", function () { return __awaiter(_this, void 0, void 0, function () {
    var app, resolver, response;
    var _this = this;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                resolver = function (fragmentID, props, req, res) {
                    ...
                    var Component = function (p) { return react_1.default.createElement("div", null,
                        "Hello ",
                        p.name); };
                    Component.getInitialProps = function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
...
test("invalid signature", function () { return __awaiter(_this, void 0, void 0, function () {
    var app, resolver, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
