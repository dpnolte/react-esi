...
function serveFragment(req, res, resolve, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var url, expectedSign, rawProps, props, fragmentID, Component, esi, baseChildProps, childProps, _b, encodedProps, markup;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    markup = server_1.renderToStaticMarkup(react_1.default.createElement(Component, __assign({}, childProps)));
                    res.write(markup);
                    res.end();
                    return [2 /*return*/];
            }
