 ...
 */
function serveFragment(req, res, resolve, _a) {
    var pipeStream = (_a === void 0 ? {} : _a).pipeStream;
    return __awaiter(this, void 0, void 0, function () {
        var url, expectedSign, rawProps, props, fragmentID, Component, esi, baseChildProps, childProps, _b, encodedProps, stream, removeReactRootStream, lastStream;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    res.write("<script>window.__REACT_ESI__ = window.__REACT_ESI__ || {}; window.__REACT_ESI__['" + fragmentID + "'] = " + encodedProps + ";document.currentScript.remove();</script>");
                    ...
                    stream.pipe(removeReactRootStream, { end: false });
                    lastStream = removeReactRootStream;
                    if (pipeStream) {
                        lastStream = pipeStream(removeReactRootStream);
                    }
                    lastStream.pipe(res, { end: false });
