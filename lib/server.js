...
function serveFragment(req, res, resolve, _a) {
    var onStream = (_a === void 0 ? {} : _a).onStream;
    return __awaiter(this, void 0, void 0, function () {
        var url, expectedSign, rawProps, props, fragmentID, Component, esi, baseChildProps, childProps, _b, encodedProps, stream, removeReactRootStream;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    removeReactRootStream.pipe(res, { end: false });
